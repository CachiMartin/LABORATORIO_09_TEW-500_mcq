...
$query = "UPDATE tbl_estudiante SET nombre='$nombre', apellido='$apellido', email='$email'  
...
<label>Nombre: </label> 
<input class="form-control" type="text" name="nombre" value="<?php echo 
(isset($nombre))?$nombre:''; ?>"> 
</div> 
<div class="form-group"> 
<label>Apellido: </label> 
<input class="form-control" type="text" name="apellido" value="<?php echo 
