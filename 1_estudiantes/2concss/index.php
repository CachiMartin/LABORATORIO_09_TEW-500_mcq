...
$email = $_POST['email'];
$query = "INSERT INTO tbl_estudiante (nombre, apellido, email) 
...
$query = "UPDATE tbl_estudiante SET nombre='$nombre', apellido='$apellido', 
email='$email' WHERE id = $id_estudiante";
$res = $conn->query($query);
...
<input type="hidden" name="id_estudiante" value="<?php echo 
(isset($id_estudiante))?$id_estudiante:''; ?>"> 
<div class="w3-cell-row w3-center w3-padding"> 
Nombre: <input style="margin:10px;display: inline-block;" type="text" 
name="nombre" value="<?php echo (isset($nombre))?$nombre:''; ?>"> 
Apellido: <input style="margin:10px;display: inline-block;" type="text" 
name="apellido" value="<?php echo (isset($apellido))?$apellido:''; ?>"> 
Email: <input style="margin:10px;display: inline-block;" type="text" 
...
<?php
    ...
    echo "<td><a href='index.php?id_estudiante=" . $row['id'] .  
    "'>Seleccionar</a></td>"; 
    echo "</tr>";  
    } 
    ?> 
